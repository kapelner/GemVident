...
/**
 * <p>
 * A class that helps store logical matrices in an efficient 1-bit per value format. A watered down implementation
 * of the QuickBitVector class in the COLT CERN libraries. 
 * </p>
 * <p>
 ...
 * </p>
 * <b>
 * WARNING: Methods of this class do not check preconditions.</b>
 ...
 *
 * @param     nBits   the number of elements to be stored in the bitvector (must be &gt;= 0).
 * @return    a low level bitvector.
 */
public static long[] makeBitVector(long nBits){
	int unitIndex =(int)(nBits/64);
