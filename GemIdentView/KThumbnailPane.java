...
//		System.out.println("drawThumbnails xoff:"+x_offset);	
	...
	//				System.out.println(stain.getName());
					TrainingImageData imageData=stain.getTrainingImage(filename);
					if (imageData == null){
	//					System.out.println("imageData null");
						numbers.add(0);
					}
					else {
	//					System.out.println("nonull:"+stain.getName()+" n:"+imageData.getNumPoints());
						numbers.add(imageData.getNumPoints());
					}
				}
				else {
					Phenotype phenotype=(Phenotype)info.getTrainer();
//					System.out.println(phenotype.getName());
