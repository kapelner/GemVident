...
public class ClassifyProgress {
	...
	/** the portion of a PostProcessBar's progress apportioned to actually {@link GemIdentCentroidFinding.CentroidFinder#EvaluateImages pinpointing centroids in classification results} */
...
//		}		
	...
	public void setupTextOutput(){
		totProgressBar.addChangeListener(
				new ChangeListener(){
					public void stateChanged(ChangeEvent e) {
						System.out.println((Integer) totProgressBar.getValue());;
					}	
				});
	}
	public Box getBox() {
