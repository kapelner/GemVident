...
//		System.out.println("KITP.repaint");
...
//		System.out.println("KImageTrainPanel           pw: " + p_width + " ph: " + p_height + " iw: " + i_width + " ih: " + i_height + " xo: " + x_0 + " yo: " + y_0);
		
//		g.drawImage(this.displayImage.getAsBufferedImage(),x_0,y_0,i_width,i_height,null);
//		
		
//		System.out.println("KITP.repaint continues (1)");
...
//        	System.out.println("isOverImage: "+isOverImage.hashCode());
		}
...
//		System.out.println("KITP.repaint ends");
	}
