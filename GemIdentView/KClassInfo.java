...
//			setPreferredSize(identifierPanelSize);
		...
		public void paintComponent(Graphics g){
//			System.out.println("drawing magnify pane zoom level:"+zoomLevel);
...
//		setPreferredSize(classInfoSize);
		...
		identifierButton = new IdentifierToggleButton();
...
//		System.out.println("num_p:"+num_pixels+" pixel_l.size()"+pixel_locations.size()+" num_points"+num_points);	
		if (num_points == 0)			
			image=null;
		else {
	...
	//				System.out.println("num_p:"+num_pixels+" pixel_locations.size():"+pixel_locations.size()+" num_points:"+num_points+" new_index:"+new_index);	
